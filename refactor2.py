...
class RefactorExample(wx.Frame):
    ...
    def creteButtonBar(self, panel):
        self.buildButton(panel, "First", self.OnFirst)
        self.buildButton(panel, "<< PREV", self.OnPrev, (80, 0))
        self.buildButton(panel, "NEXT >>", self.OnNext, (160, 0))
        self.buildButton(panel, "Last", self.OnLast, (240, 0))

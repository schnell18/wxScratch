...
class ImpDialog(wx.Dialog):
    ...
    def __init__(self, parent, bundle):
        ...
        progressSizer.Add(self.progressBar, 3, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5)
        ...
        progressSizer.Add(self.cancelBtn, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5)
        ...
        for curri in bundle.curricula:
            ...
            imgSizer.Add(img, 4, wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL|wx.ALL, 2)
            imgSizer.Add(imgLbl, 1, wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_CENTER_VERTICAL|wx.ALL, 2)
            qrSizer.Add(imgSizer, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_CENTER_VERTICAL|wx.ALL, 2)
